...
// func toSlice(obj any) (slice []any) {
// 	switch x := obj.(type) {
// 	case map[string]string:
// 		slice = make([]any, 0, len(x)*2)
// 		for k, v := range x {
...
// 			panic("请传入结构体指针或map[string]string")
// 		}
// 		rv = rv.Elem()
...
// 		slice = make([]any, 0, rv.NumField()*2)
// 		for i := 0; i < rv.NumField(); i++ {
// 			field := rv.Type().Field(i)
// 			slice = append(slice, field.Name, rv.Field(i).Interface())
// 		}
